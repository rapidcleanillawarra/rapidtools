      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Incomplete Contact Information</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-4 bg-[#181b20] border-t border-[#262a30] rounded-b-2xl flex space-x-3">
          ...
          <button
            ...
            class="btn-primary flex-1 py-2 text-sm justify-center"
          >
            Go Back
          </button>
        </div>
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Pickup Job Submitted</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-4 bg-[#181b20] border-t border-[#262a30] rounded-b-2xl">
          <button
            type="button"
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Pickup Job Created</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-5 text-sm text-gray-300 leading-relaxed">
          ...
          <div class="bg-blue-950/30 border border-blue-500/30 rounded-xl p-3.5">
            <div class="flex">
              <div class="flex-shrink-0">
              ...
              <div class="ml-3">
                <p class="text-sm text-blue-300">
                  <strong class="font-semibold text-white">Next Step:</strong> Monitor the workshop board to track when the equipment arrives and the job status updates.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Docket Information Saved</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-5 text-sm text-gray-300 leading-relaxed">
          ...
          <div class="bg-lime-950/30 border border-lime-500/30 rounded-xl p-3.5">
            <div class="flex">
              <div class="flex-shrink-0">
              ...
              <div class="ml-3">
                <p class="text-sm text-lime-300">
                  <strong class="font-semibold text-white">Job Status:</strong> Updated to "Docket Ready"
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Waiting for PO Approval</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-5 text-sm text-gray-300 leading-relaxed">
          ...
          <div class="bg-blue-950/30 border border-blue-500/30 rounded-xl p-3.5">
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-sm text-blue-300">
                  <strong class="font-semibold text-white">Job Status:</strong> Updated to "Waiting Approval PO"
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Waiting For Parts</h3>
            </div>
          </div>
        </div>
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-sm text-amber-300">
                  <strong class="font-semibold text-white">Job Status:</strong> Updated to "Waiting For Parts"
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Booked In For Repair</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-5 text-sm text-gray-300 leading-relaxed">
          ...
          <div class="bg-lime-950/30 border border-lime-500/30 rounded-xl p-3.5">
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-sm text-lime-300">
                  <strong class="font-semibold text-white">Job Status:</strong> Updated to "Booked In For Repair Service"
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Repair Completed</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-5 text-sm text-gray-300 leading-relaxed">
          ...
          <div class="bg-lime-950/30 border border-lime-500/30 rounded-xl p-3.5">
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-sm text-lime-300">
                  <strong class="font-semibold text-white">Job Status:</strong> Updated to "Repaired"
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Equipment Ready for Return</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-5 text-sm text-gray-300 leading-relaxed">
          ...
          <div class="bg-blue-950/30 border border-blue-500/30 rounded-xl p-3.5">
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-sm text-blue-300">
                  <strong class="font-semibold text-white">Job Status:</strong> Updated to "Return"
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Job Completed</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-5 text-sm text-gray-300 leading-relaxed">
          ...
          <div class="bg-lime-950/30 border border-lime-500/30 rounded-xl p-3.5">
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-sm text-lime-300">
                  <strong class="font-semibold text-white">Job Status:</strong> Updated to "Completed"
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-6 text-center">
          <div class="flex justify-center mb-4">
            <svg class="animate-spin h-12 w-12 text-lime-400" fill="none" viewBox="0 0 24 24">
              <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
              <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
          </div>

          <h3 class="text-lg font-bold text-white mb-4">Creating Your Workshop Job</h3>

          <!-- Progress Checklist -->
          <div class="space-y-3 mb-6 text-left">
            {#each Object.entries(processingSteps) as [key, step]}
              <div class="flex items-center justify-between p-3 rounded-xl border {step.completed ? 'bg-lime-950/20 border-lime-500/30' : step.inProgress ? 'bg-[#1f2329] border-lime-500/40' : 'bg-[#141619] border-[#262a30]'}">
                <div class="flex items-center">
                  <div class="flex-shrink-0 mr-3">
                    ...
                    {:else if step.inProgress}
                      <!-- In progress spinner -->
                      <svg class="animate-spin w-5 h-5 text-lime-400" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                      </svg>
                    {:else}
                      <!-- Pending -->
                      <div class="w-5 h-5 rounded-full border-2 border-[#333842]"></div>
                    {/if}
                  </div>
                  <span class="text-sm font-medium {step.completed ? 'text-lime-300' : step.inProgress ? 'text-lime-400 font-semibold' : 'text-gray-400'}">
                    {step.label}
                  </span>
                </div>
                {#if step.completed}
                  <span class="text-xs text-lime-400 font-bold">✓</span>
                {/if}
              </div>
            {/each}
          </div>

          <div class="bg-blue-950/30 border border-blue-500/30 rounded-xl p-3 mb-2">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4">
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-6 text-center">
          ...
          <h3 class="text-lg font-bold text-white mb-4">Deleting Workshop Job</h3>

          <!-- Progress Checklist -->
          <div class="space-y-3 mb-6 text-left">
            {#each Object.entries(deleteProcessingSteps) as [key, step]}
              <div class="flex items-center justify-between p-3 rounded-xl border {step.completed ? 'bg-lime-950/20 border-lime-500/30' : step.inProgress ? 'bg-red-950/30 border-red-500/40' : 'bg-[#141619] border-[#262a30]'}">
                <div class="flex items-center">
                  <div class="flex-shrink-0 mr-3">
                    {#if step.completed}
                      <!-- Completed checkmark -->
                  ...
                  <span class="text-sm font-medium {step.completed ? 'text-lime-300' : step.inProgress ? 'text-red-300 font-semibold' : 'text-gray-400'}">
                    {step.label}
                  </span>
                </div>
                {#if step.completed}
          ...
          <div class="bg-red-950/30 border border-red-500/30 rounded-xl p-3 mb-2">
            <div class="flex items-center justify-center">
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Customer Billing Information Required</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-5 text-sm text-gray-300 leading-relaxed">
          ...
          <div class="bg-amber-950/30 border border-amber-500/30 rounded-xl p-3.5 mb-2">
            <div class="flex">
              <div class="flex-shrink-0">
                <svg class="w-5 h-5 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
              ...
              <div class="ml-3">
                <p class="text-sm text-amber-300">
                  <strong class="font-semibold text-white">What to do:</strong> Update the customer's billing information in Maropost with their first name and last name.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="px-6 py-4 bg-[#181b20] border-t border-[#262a30] rounded-b-2xl flex space-x-3">
          ...
          {#if selectedCustomer}
            <a
              ...
              target="_blank"
              on:click={() => showCustomerBillingModal = false}
              class="btn-primary flex-1 py-2 text-sm text-center inline-flex items-center justify-center"
            >
              Update in Maropost
            </a>
          {/if}
      ...
      <div class="bg-[#141619] border border-[#262a30] rounded-2xl shadow-2xl max-w-md w-full text-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-[#262a30] bg-[#181b20]">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <h3 class="text-lg font-bold text-white">Delete Workshop Job</h3>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 py-5 text-sm text-gray-300 leading-relaxed">
          ...
          <div class="bg-red-950/30 border border-red-500/30 rounded-xl p-3.5 mb-2">
            <div class="flex">
              <div class="flex-shrink-0">
              ...
              <div class="ml-3">
                <p class="text-sm text-red-300">
                  <strong class="font-semibold text-white">Warning:</strong> This will permanently remove the job and all associated photos from the system.
                </p>
              </div>
            </div>
          </div>
