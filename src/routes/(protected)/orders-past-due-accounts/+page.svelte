						...
						<tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
							...
							{:else}
								{#each filteredOrders as order, index}
									...
									<tr class="!border-b-0 {index % 2 === 0 ? 'bg-white dark:bg-gray-900' : 'bg-gray-50 dark:bg-gray-800/50'}">
										<td
											class="pl-4 pr-3 py-4 text-sm font-medium text-gray-900 dark:text-gray-100 sm:pl-6 !border-b-0"
										>
											{#if order.username}
												<a
													...
													class="inline-flex items-center gap-1.5 text-[rgb(40,40,40)] hover:text-black dark:text-gray-200 dark:hover:text-white transition-colors group"
												>
													<span>{order.customer}</span>
													<svg class="w-4 h-4 opacity-70 group-hover:opacity-100 group-hover:scale-110 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										...
										>
											{#if order.contacts}
												<div class="flex items-center gap-2">
													...
													>
														...
														<svg class="w-3.5 h-3.5 opacity-70 group-hover:opacity-100 group-hover:scale-110 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
															<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
															<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
														</svg>
													</a>
											...
											{:else}
												<div class="flex items-center gap-2">
													...
													<span class="text-gray-400 dark:text-gray-500 italic">No phone</span>
												</div>
											{/if}
										</td>
									</tr>
									<!-- Email row -->
									<tr class="!border-t-0 {index % 2 === 0 ? 'bg-white dark:bg-gray-900' : 'bg-gray-50 dark:bg-gray-800/50'}">
										<td
											class="pl-4 pr-3 py-2 text-sm text-gray-600 dark:text-gray-400 sm:pl-6 !border-t-0"
										>
											{#if order.email}
												<div class="flex items-center gap-2">
													<svg class="w-4 h-4 text-gray-400 dark:text-gray-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
