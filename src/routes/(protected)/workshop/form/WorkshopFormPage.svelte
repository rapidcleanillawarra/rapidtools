<script lang="ts">
  ...
  type JobStatus = 'new' | 'pickup' | 'to_be_quoted' | 'docket_ready' | 'quoted' | 'repaired' | 'waiting_approval_po' | 'waiting_for_parts' | 'booked_in_for_repair_service' | 'deliver_to_workshop' | 'pending_jobs' | 'return' | 'completed' | 'to_be_scrapped' | 'pickup_from_workshop' | 'warranty_claim' | null;
...
<body>
  ...
  <div class="bg-white rounded-lg shadow-lg overflow-hidden">
    <WorkshopHeader {existingWorkshopId} {workshopStatus} {existingOrderId} {currentJobStatus} {startedWith} />
